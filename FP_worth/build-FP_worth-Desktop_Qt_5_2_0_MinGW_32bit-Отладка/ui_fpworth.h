...
public:
    ...
    void setupUi(QMainWindow *FPWorth)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(0, -5, 1021, 581));
        ...
        horizontalLayoutWidget_10->setGeometry(QRect(10, 10, 451, 461));
        ...
        label_4 = new QLabel(horizontalLayoutWidget_10);
        label_4->setObjectName(QStringLiteral("label_4"));

        verticalLayout_2->addWidget(label_4);

        inputComboBox = new QComboBox(horizontalLayoutWidget_10);
        inputComboBox->setObjectName(QStringLiteral("inputComboBox"));

        verticalLayout_2->addWidget(inputComboBox);
        ...
        normalTable->setGeometry(QRect(20, 20, 871, 471));
        ...
        new QListWidgetItem(rulesListWidget);
    ...
    {
        FPWorth->setWindowTitle(QApplication::translate("FPWorth", "FPWorth", 0));
        openNormalButton->setText(QApplication::translate("FPWorth", "Open normal file", 0));
        ...
        openFuzzyButton->setText(QApplication::translate("FPWorth", "Open fuzzy file", 0));
        ...
        ___qtreewidgetitem8->setText(1, QApplication::translate("FPWorth", "\321\204\321\204\321\204", 0));
        ___qtreewidgetitem8->setText(0, QApplication::translate("FPWorth", "\320\235\320\276\320\262\321\213\320\271 \321\215\320\273\320\265\320\274\320\265\320\275\321\202", 0));
        ...
        label_4->setText(QApplication::translate("FPWorth", "\320\244\320\276\321\200\320\274\320\260\321\202 \320\264\320\260\320\275\320\275\321\213\321\205: ", 0));
        inputComboBox->clear();
        inputComboBox->insertItems(0, QStringList()
         << QApplication::translate("FPWorth", "\320\222\321\213\320\261\321\200\320\260\321\202\321\214", "0")
         << QApplication::translate("FPWorth", "\320\247\320\270\321\201\320\273\320\265\320\275\320\275\321\213\320\265 \320\276\321\202 0 \320\264\320\276 N", "1")
         << QApplication::translate("FPWorth", "\320\242\320\265\320\272\321\201\321\202\320\276\320\262\321\213\320\265", "2")
        );
        label->setText(QApplication::translate("FPWorth", "Separator:", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("FPWorth", "\320\235\320\265\321\207\320\265\321\202\320\272\320\270\320\271 \320\262\320\270\320\264", 0));
        ...
        const bool __sortingEnabled3 = rulesListWidget->isSortingEnabled();
        rulesListWidget->setSortingEnabled(false);
        QListWidgetItem *___qlistwidgetitem = rulesListWidget->item(0);
        ___qlistwidgetitem->setText(QApplication::translate("FPWorth", "\320\227\320\264\320\265\321\201\321\214 \320\275\320\270\321\207\320\265\320\263\320\276 \320\275\320\265\321\202.", 0));
        rulesListWidget->setSortingEnabled(__sortingEnabled3);
        ...
        const bool __sortingEnabled4 = supportTable->isSortingEnabled();
        ...
        supportTable->setSortingEnabled(__sortingEnabled4);
        ...
        makePlotButton->setText(QApplication::translate("FPWorth", "Make Plot", 0));
        ...
        label_13->setText(QApplication::translate("FPWorth", "diffstep:", 0));
        ...
        label_16->setText(QApplication::translate("FPWorth", "maxits:", 0));
        maxitsEdit->setText(QApplication::translate("FPWorth", "0", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("FPWorth", "\320\223\321\200\320\260\321\204\320\270\320\272", 0));
        ...
        const bool __sortingEnabled5 = inputNnpsTable->isSortingEnabled();
        ...
        inputNnpsTable->setSortingEnabled(__sortingEnabled5);
